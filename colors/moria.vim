...
if &background == "dark"
    ...
    if s:moria_monochrome == 1
        ...
        hi FoldColumn ctermbg=bg guibg=bg guifg=#a2aabf gui=none
        hi LineNr guifg=#a2aabf gui=none
        hi NonText ctermfg=DarkGray guibg=bg guifg=#a2aabf gui=bold
        hi Pmenu guibg=#7c87a5 guifg=#000000 gui=none
        hi PmenuSbar guibg=#5b6684 guifg=fg gui=none
        hi PmenuThumb guibg=#c8ccd9 guifg=bg gui=none
        hi SignColumn ctermbg=bg guibg=bg guifg=#a2aabf gui=none
        hi StatusLine ctermbg=LightGray ctermfg=Black guibg=#485168 guifg=fg gui=bold
        hi StatusLineNC ctermbg=DarkGray ctermfg=Black guibg=#343a4b guifg=fg gui=none
        hi TabLine guibg=#5b6684 guifg=fg gui=underline
        hi TabLineFill guibg=#5b6684 guifg=fg gui=underline
        hi VertSplit ctermbg=LightGray ctermfg=Black guibg=#343a4b guifg=fg gui=none
        if s:moria_fontface == "mixed"
            hi Folded guibg=#4e4e4e guifg=#c8ccd9 gui=bold
        else
            hi Folded guibg=#4e4e4e guifg=#c8ccd9 gui=none
        endif            
    endif
...
elseif &background == "light"
    ...
    if s:moria_monochrome == 1
        ...
        hi FoldColumn ctermbg=bg guibg=bg guifg=#4e5772 gui=none
        hi Folded guibg=#cfcfcf guifg=#343a4b gui=bold
        hi LineNr guifg=#4e5772 gui=none
        hi MoreMsg guibg=bg guifg=#41495f gui=bold
        hi NonText ctermfg=DarkGray guibg=bg guifg=#4e5772 gui=bold
        hi Pmenu guibg=#8892ac guifg=#000000 gui=none
        hi PmenuSbar guibg=#687597 guifg=fg gui=none
        hi PmenuThumb guibg=#b5bbcc guifg=fg gui=none
        hi SignColumn ctermbg=bg guibg=bg guifg=#4e5772 gui=none
        hi StatusLine ctermbg=Black ctermfg=White guibg=#a2aabf guifg=fg gui=bold
        hi StatusLineNC ctermbg=LightGray ctermfg=Black guibg=#b5bbcc guifg=fg gui=none
        hi TabLine guibg=#c4c9d7 guifg=fg gui=underline
        hi TabLineFill guibg=#c4c9d7 guifg=fg gui=underline
        hi VertSplit ctermbg=LightGray ctermfg=Black guibg=#b5bbcc guifg=fg gui=none
    endif
